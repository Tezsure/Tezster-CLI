...
(function (TezosNodeWriter) {
    ...
    function testOperation(server, operations, keyStore, derivationPath = '', chainid = 'main') {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield performPostRequest(server, `chains/${chainid}/blocks/head/helpers/scripts/run_operation`, { chain_id: blockHead.chain_id, operation: { branch: blockHead.hash, contents: [...operations], signature: signedOpGroup.signature } });
