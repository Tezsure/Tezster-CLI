...
export declare namespace TzbtcTokenHelper {
    ...
    function mintBalance(server: string, keystore: KeyStore, contract: string, fee: number, destination: string, amount: number, gas?: number, freight?: number): Promise<string>;
    function addOperator(server: string, keystore: KeyStore, contract: string, fee: number, operator: string, gas?: number, freight?: number): Promise<string>;
}
