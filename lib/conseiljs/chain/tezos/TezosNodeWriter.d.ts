...
export declare namespace TezosNodeWriter {
    ...
    function sendContractOriginationOperation(server: string, keyStore: KeyStore, amount: number, delegate: string | undefined, fee: number, derivationPath: string | undefined, storageLimit: number, gasLimit: number, code: string, storage: string, codeFormat?: TezosTypes.TezosParameterFormat): Promise<TezosTypes.OperationResult>;
