...
function activateAlpha() {
    ...
    ./tezos/tezos-client -base-dir ./tmp -addr localhost -port 18731  -block genesis activate protocol PsddFKi32cMJ2qPjf43Qv5GDWLDPZb3T3bF6fLKiF5HtvHNU7aP with fitness 1 and key activator and parameters ./tezos/scripts/protocol_parameters.json --timestamp $(TZ='AAA+1' date +%FT%TZ)
}
